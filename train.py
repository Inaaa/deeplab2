...
flags.DEFINE_integer('num_replicas', 4, 'Number of worker replicas.')
...
flags.DEFINE_float('base_learning_rate', .00001,
                   'The base learning rate for model training.') ##.0001,
...
flags.DEFINE_integer('slow_start_step', 1,
...
flags.DEFINE_string('dataset_dir', '/mrtstorage/users/chli/cityscapes/tfrecord', 'Where the dataset reside.')
