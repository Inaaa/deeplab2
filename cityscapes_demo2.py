...
#checkpoint_path = "/mrtstorage/users/chli/cityscapes_slope/exp/train_on_train_set/xyz.tar.xz"
...
vc = cv2.VideoCapture('/home/chli/cc_code2/deeplab/Driving the Trans-Canada Highway in Newfoundland.mp4')
...
while rval:
    rval, frame = vc.read()
    image, seg_map = run_visualization(frame)
    seg_map = np.array(seg_map)

    path = os.path.join('/home/chli/cc_code2/deeplab/images2/',str(i)+'.jpg')
    print(path)
